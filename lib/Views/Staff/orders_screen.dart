  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          await staffController.fetchOrders();
        },
        child: Obx(() {
          if (staffController.isLoadingOrders.value) {
          ...
          } else if (staffController.orders.isEmpty) {
            return Center(
              child: Text(
                'No orders found.',
            ...
            return GridView.builder(
              ...
              itemCount: staffController.orders.length,
              itemBuilder: (context, index) {
                final order = staffController.orders[index];
                return _OrderCard(
                  order: order,
                  isMobile: isMobile,
                  onStatusChange: () =>
